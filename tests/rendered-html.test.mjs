...
test("server-renders the VitaSense website", async () => {
  ...
  assert.match(html, /service-icons\/nerve-test\.png/);
  assert.match(html, /service-icons\/allergy-test\.png/);
  assert.match(html, /service-icons\/circulation-test\.png/);
...
test("keeps the finished site free of starter scaffolding and forced scrolling", async () => {
  ...
  await Promise.all([
    ...
    access(new URL("../public/service-icons/nerve-test.png", import.meta.url)),
    access(new URL("../public/service-icons/allergy-test.png", import.meta.url)),
    access(new URL("../public/service-icons/circulation-test.png", import.meta.url)),
  ]);
